							...
							<div class="detail-table">
								...
								<div class="product-table">
									...
									<div class="product-table-cell">
										...
										<div class="product-table-info">
											<div
												data-wf-sku-bindings="%5B%7B%22from%22%3A%22f_width_%22%2C%22to%22%3A%22innerHTML%22%7D%5D">${vo.inwon}
											</div>
										</div>
									</div>	
									<div class="product-table-cell">
									...
									<div class="product-table-cell">
										...
										<div class="product-table-info">
											<div
												data-wf-sku-bindings="%5B%7B%22from%22%3A%22f_width_%22%2C%22to%22%3A%22innerHTML%22%7D%5D">${vo.evo.loc}
											</div>
										</div>
									</div>									
									<div class="product-table-cell">
										...
										<div class="product-table-info">
											<div
												data-wf-sku-bindings="%5B%7B%22from%22%3A%22f_height_%22%2C%22to%22%3A%22innerHTML%22%7D%5D">${vo.evo.loc_detail}</div>
										</div>
									</div>
								</div>
							</div>
